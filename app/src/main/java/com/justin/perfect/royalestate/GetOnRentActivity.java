...
public class GetOnRentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_on_rent);
        ...
        next_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (area.isEmpty()){
                    ...
                    Intent intent = new Intent(GetOnRentActivity.this,BuyBudgetAndPropertyTypeActivity.class);
                    intent.putExtra("area",area);
                    intent.putExtra("city",city);
                    intent.putExtra("uniqid","getOnRent");
